        ...
        <div className="main-bg">
            <div className="container d-flex justify-content-center align-items-center vh-100">
                <div className="d-flex justify-content-center">
                    <div className="col-12 d-flex flex-column align-items-center justify-content-center rounded-border boxSha py-5 px-4 bg-light" >
                        <img className="login-logo mb-3" src={Logo} alt="لوگوی دیوار مهربانی" />

                        <form className="form-group" onSubmit={(e) => login(e)}>

                            <div className="d-flex flex-column align-items-start">
                                <p className='h3 text-center color-theme mt-1 mb-4'>کد تایید را وارد نمایید</p>
                                <p className="font-weight-lighter text-right">کد تایید به شماره موبایل {mobileNumber} ارسال گردید</p>
                            </div>
